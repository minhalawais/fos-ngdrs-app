...
import { CheckCircle2, AlertTriangle, XCircle, Clock, Database, Activity, TrendingUp } from "lucide-react";
        ...
        <div className="space-y-8">
            ...
            <div className="flex items-end justify-between">
                <div>
                    ...
                    <h1 className="text-3xl font-heading font-bold text-brand-dark">Platform Accountability</h1>
                    <p className="text-brand-teal/80 mt-1">Social Media Compliance Monitoring (TFGBV)</p>
                </div>
            </div>
