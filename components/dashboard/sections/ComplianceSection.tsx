    ...
    return (
        <section id="compliance" className="space-y-8 relative scroll-mt-28">
            ...
            <div className="flex items-end justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-brand-dark">Strategic Compliance & Global Reporting</h2>
                    <p className="text-brand-teal mt-1">Monitoring International Obligations (CEDAW, SDG 5, GSP+) & Emerging Threats</p>
                </div>
