    ...
    return (
        <section id="services" className="space-y-8 scroll-mt-28">
            <div className="flex items-end justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-brand-dark">Survivor Support Matrix</h2>
                    <p className="text-brand-teal mt-1">Monitoring Service Provision & Resource Gaps</p>
                </div>
